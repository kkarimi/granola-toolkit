...
| P1       | Pending     | M    |              | Gran / KB Plugin Seam | Move markdown vault and Obsidian-facing publish behavior behind Yazd knowledge-base plugin interfaces.      | Publishing should become source-agnostic.                         |
