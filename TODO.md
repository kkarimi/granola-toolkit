...
| P2       | In Progress | M    |              | Yazd / Pi Plugin      | Integrate Gran with a future Pi/OpenClaw agent plugin package built on the Yazd agent contract.             | Pi support fits better as a Yazd ecosystem package.               |
