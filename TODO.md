...
Status note:
All current launch-roadmap items are implemented on `main` and intentionally unreleased. The remaining decision is product judgement: do one more coherence pass, or cut the next batched release from this new browser baseline.
