...
| P1       | In Progress | L    |              | Architecture / Core Trim | Split or shrink the biggest Gran pressure points: `core`, `automation-service`, and browser state glue.                                                   | Big files are the main drag on clarity and future changes.          |
