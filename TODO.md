...
| P1       | Done        | M    |              | UX / Guided Setup      | Add a terminal-first setup flow that can launch web or stay in TUI, save auth, run first sync, and land in the chosen workspace.    | Setup should feel like a product moment, not a pile of commands.     |
