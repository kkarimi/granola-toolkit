...
| P1       | Pending     | M    |              | UX / Settings          | Reframe Settings around Connection, Publishing, Automation, and Advanced instead of raw implementation sections.                    | Users think in jobs, not internal subsystem names.                   |
| P1       | Pending     | M    |              | UX / Review            | Rename and reshape Review around human decisions like Needs Recovery, Needs Approval, and Ready To Publish.                         | Review still exposes pipeline nouns instead of user tasks.           |
